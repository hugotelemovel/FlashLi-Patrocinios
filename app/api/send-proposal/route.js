...
export async function POST(request) {
  ...
  if (empresa.idioma === 'ES') {
    ...
    corpoHTML = `
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; line-height: 1.6;">
        ...
        <p>Nuestra escuela representará a Portugal en la gran final mundial en Dublín (Julio de 2026). ¡Solo el mes pasado logramos <b>24 podios y 15 Medallas de Oro</b> en la final nacional!</p>
  ...
  try {
    await resend.emails.send({
      from: 'onboarding@resend.dev', // TEM DE SER ASSIM NO PLANO GRATUITO
      to: empresa.email,
      subject: assunto,
      html: corpoHTML
    });
